...
export const HERO_CONTENT = `I am an enthusiastic full stack developer with expertise in the MERN stack, including React.js, Next.js, and JavaScript, as well as back-end technologies like Node.js, MongoDB, SQL, and Java. As a fresher, I am passionate about building responsive and dynamic web applications that deliver outstanding user experiences. With a strong foundation in both front-end and back-end development, I am eager to contribute innovative solutions that drive business growth and add value.`;

export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating efficient and user-friendly web applications. As a fresher, I have developed a strong foundation in front-end technologies like React.js, Next.js, HTML, CSS, Tailwind CSS, and Redux, along with back-end expertise in Node.js, MongoDB, SQL, JavaScript, and Java. My journey in web development began with a deep curiosity for technology, which has grown into a commitment to continuous learning and adapting to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I love exploring new technologies and contributing to innovative projects.`;
